...
@Component({
  selector: 'app-patient-privacy-and-security',
  imports: [ReactiveFormsModule, CommonModule, FormsModule, TranslateModule],
  templateUrl: './patient-privacy-and-security.component.html',
  styleUrl: './patient-privacy-and-security.component.css',
})
export class PatientPrivacyAndSecurityComponent {
