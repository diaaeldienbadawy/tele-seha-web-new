...
@Component({
  selector: 'app-doctor-non-recurring-appointments',
  imports: [CommonModule, ReactiveFormsModule, DatePickerModule, NgxMaterialTimepickerModule],
  templateUrl: './doctor-non-recurring-appointments.component.html',
  styleUrl: './doctor-non-recurring-appointments.component.css',
})
export class DoctorNonRecurringAppointmentsComponent implements OnInit {
  form!: FormGroup;
  doctorId!: number;
