...
@Component({
  ...
  imports: [CommonModule, BookingSessionComponent, TranslateModule],
  templateUrl: './doctor-todays-appointments-section.component.html',
  styleUrl: './doctor-todays-appointments-section.component.css',
})
export class DoctorTodaysAppointmentsSectionComponent implements OnInit {
  ...
  loadTodaysAppointments() {
    this.doctorService.getAppointmentsToday(Number(this.doctorId)).subscribe({
      next: (res: any[]) => {
